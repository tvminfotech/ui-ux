...
import { WorkSpacePrototypeService } from './work-space-prototype.service';
...
@Component({
  ...
  styleUrls: ['./work-space-prototype.component.css']
})
export class WorkSpacePrototypeComponent implements OnInit {
  method: string = 'SAVE';
  formGroup: FormGroup;
  ...
  canShowReviewer: boolean = false; token = localStorage.getItem('tempCurrentUserToken');
  header = {
